...
java -jar Tools\swagger-codegen-cli-2.3.1.jar generate -i http://api-dev.aspose.cloud/v1.1/imaging/swagger/spec -l java -DsupportJava6=true -t Templates\Java -o %sdkfolder% -c config.java.json || goto :error
