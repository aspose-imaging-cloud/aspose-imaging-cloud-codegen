...
java -jar Tools\swagger-codegen-cli-2.3.1.jar generate -i http://api-dev.aspose.cloud/v1.1/imaging/swagger/spec -l csharp -t Templates\csharp -o %sdkfolder% -c config.net.json || goto :error
