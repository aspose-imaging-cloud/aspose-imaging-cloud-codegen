...
java -jar Tools\swagger-codegen-cli-2.3.1.jar generate -i https://api-qa.aspose.cloud/v3.0/imaging/swagger/spec -l csharp -t Templates\csharp -o %sdkfolder% -c config.net.json || goto :error
