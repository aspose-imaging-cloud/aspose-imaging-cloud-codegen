...
java -jar Tools\swagger-codegen-cli-2.3.1.jar generate -i http://api-dev.aspose.cloud/v2/imaging/swagger/spec -l php -t Templates\php -o %sdkfolder% --invoker-package Aspose\Imaging --model-package Model --api-package Api --import-mappings SaaSposeResponse=SaaSposeResponse --import-mappings HttpStatusCode=HttpStatusCode || goto :error
